import { LatLngBounds, LatLngExpression, LayerOptions, LeafletEventHandlerFnMap, PolylineOptions, Map, LayerGroup, Polyline } from 'leaflet';
...
export default class AutoGraticule extends LayerGroup {
    ...
    buildLabel(axis: 'gridlabel-horiz' | 'gridlabel-vert', val: number): import("leaflet").Marker<any>;
    /**
